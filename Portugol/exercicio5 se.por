 ...
 *  ser notificados a paralisarem suas atividades. Faça um sistema que leia o índice de 
...
funcao inicio()
    {
        ...
        leia (indice)
            ...
            escreva ("\nIndices de poluentes esta em ",indice,"\n1º grupo suspendam suas atividades!")
            ...
            escreva ("\nIndices de poluentes esta instavel siga com os trabalhos!")
        }
    }
}
/* $$$ Portugol Studio $$$ 
